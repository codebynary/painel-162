            ...
            <aside className="w-64 bg-black/40 backdrop-blur-xl border-r border-white/5 flex flex-col relative z-20">
                ...
                <nav className="flex-1 p-6 space-y-2">
                    ...
                    <Link to="/admin/broadcast">
                        <motion.div
                            whileHover={{ x: 5 }}
                            className={`flex items-center space-x-3 px-6 py-4 rounded-2xl transition-all ${isActive('/admin/broadcast') ? 'bg-brand-red text-white shadow-[0_0_20px_rgba(204,0,0,0.2)]' : 'text-white/30 hover:text-white hover:bg-white/5 border border-transparent hover:border-white/10'}`}
                        >
